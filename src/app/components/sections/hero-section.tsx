  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div className={`absolute top-1/2 left-1/2 w-96 h-96 rounded-full blur-3xl animate-float ${
      ...
      <div ref={textRef} className="relative z-10 max-w-4xl text-center opacity-0 transition-opacity duration-1000">
        ...
        <p className={`text-2xl md:text-3xl mb-3 font-semibold ${
          ...
          <span className={`inline-block w-1 h-8 ml-1 ${isDarkMode ? 'bg-blue-300' : 'bg-blue-600'} animate-blink`}>|</span>
        </p>

        {/* Description (Set to white for both modes) */}
        <p className="text-base md:text-lg max-w-2xl mx-auto mb-10 leading-relaxed text-white">
          Passionate software developer with expertise in full-stack development, creating innovative solutions with modern technologies.
        </p>
