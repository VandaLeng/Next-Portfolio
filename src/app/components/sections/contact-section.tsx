...
export default function ContactSection({ isDarkMode }: ContactSectionProps) {
  ...
  return (
    <section id="contact" ref={sectionRef} className="min-h-screen py-16 px-6 opacity-0">
      <div className="max-w-5xl mx-auto w-full">
        {/* Section Header */}
        <div className="mb-8 text-center">
          <h2
            className={`text-3xl md:text-4xl font-bold mb-3 text-transparent bg-clip-text bg-gradient-to-r ${
              isDarkMode ? "from-blue-400 to-cyan-400" : "from-red-600 to-orange-600"
            }`}
          >
            Get In Touch
          </h2>
            ...
            <div
              className={`p-4 rounded-xl border transition-all duration-300 hover:scale-105 group ${
                isDarkMode
                  ...
                  : "bg-white border-red-200 hover:border-red-400 hover:shadow-xl hover:shadow-red-300/30"
              }`}
            >
              <div className="flex items-start gap-3">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0 ${
                    isDarkMode ? "bg-blue-500/20" : "bg-red-100"
                  }`}
                >
                  <Mail className={`w-5 h-5 ${isDarkMode ? "text-blue-400" : "text-red-600"}`} />
                </div>
                <div className="flex-1 min-w-0">
                  <h4 className={`text-sm font-semibold mb-0.5 ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                    Email
                  </h4>
                  <a
                    href={`mailto:${personalInfo.email}`}
                    className={`text-xs transition-colors break-all ${
                      isDarkMode ? "text-gray-400 hover:text-blue-400" : "text-gray-700 hover:text-red-600"
                    }`}
                  >
                    {personalInfo.email}
                  </a>
            ...
            <div
              className={`p-4 rounded-xl border transition-all duration-300 hover:scale-105 group ${
                isDarkMode
                  ...
                  : "bg-white border-orange-200 hover:border-orange-400 hover:shadow-xl hover:shadow-orange-300/30"
              }`}
            >
              <div className="flex items-start gap-3">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0 ${
                    isDarkMode ? "bg-cyan-500/20" : "bg-orange-100"
                  }`}
                >
                  <Phone className={`w-5 h-5 ${isDarkMode ? "text-cyan-400" : "text-orange-600"}`} />
                </div>
                <div className="flex-1">
                  ...
                  <a
                    ...
                    className={`text-xs transition-colors ${
                      isDarkMode ? "text-gray-400 hover:text-cyan-400" : "text-gray-700 hover:text-orange-600"
                    }`}
                  >
                    {personalInfo.phone}
                  </a>
            ...
            <div
              className={`p-4 rounded-xl border transition-all duration-300 hover:scale-105 group ${
                isDarkMode
                  ...
                  : "bg-white border-pink-200 hover:border-pink-400 hover:shadow-xl hover:shadow-pink-300/30"
              }`}
            >
              <div className="flex items-start gap-3">
                <div
                  className={`w-12 h-12 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform flex-shrink-0 ${
                    isDarkMode ? "bg-purple-500/20" : "bg-pink-100"
                  }`}
                >
                  <MapPin className={`w-5 h-5 ${isDarkMode ? "text-purple-400" : "text-pink-600"}`} />
                </div>
                <div className="flex-1">
                  <h4 className={`text-sm font-semibold mb-0.5 ${isDarkMode ? "text-white" : "text-gray-900"}`}>
                    Location
                  </h4>
                  <p className={`text-xs ${isDarkMode ? "text-gray-400" : "text-gray-700"}`}>{personalInfo.location}</p>
                </div>
              </div>
            </div>
          ...
          <div>
            <form
              ...
              className={`p-6 rounded-xl border space-y-4 ${
                isDarkMode ? "bg-slate-800/50 border-blue-500/20" : "bg-white border-red-200"
              }`}
            >
              {/* Name Input */}
              <div>
              ...
              <button
                ...
                className={`w-full px-6 py-3 text-sm rounded-lg font-semibold transition-all duration-300 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed hover:scale-105 group ${
                  isDarkMode
                    ...
                    : "bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-white shadow-lg shadow-red-400/50"
                }`}
              >
                {isSubmitting ? (
                  <>
