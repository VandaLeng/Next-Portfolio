...
import { projectsData } from "@/app/lib/utils"
          ...
          <a
            ...
            className={`inline-flex items-center gap-2 px-7 py-3 rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:scale-105 group text-sm md:text-base ${
              isDarkMode
                ...
                : "bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 hover:shadow-red-500/50 text-white"
            }`}
          >
